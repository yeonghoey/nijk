...
The reader provided to scorer.NewCollection should provide a contexts by a space-separated line.
The collection aggregates the term counts for each term of contexts to form aggregated contexts.
The aggregated contexts of each term is basically the basic unit of the term's context to be used for determining the similarity between two terms.
